...
namespace Formatting
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine("Numerical Formatting");
            ...
            System.Console.WriteLine("Formatting with alignment and spacing");
            ...
            System.Console.WriteLine("{0,12:C0} {1,12:C0} {2,12:C0} {3,12:C0}", 
                ...
                System.Console.WriteLine("----------------------------------------");
            System.Console.WriteLine("{0,12:P0} {1,12:P1} {2,12:P2} {3,12:P3}", 
